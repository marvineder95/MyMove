...
const InventoryEditView = () => import('@/views/InventoryEditView.vue')
const OfferComparisonView = () => import('@/views/OfferComparisonView.vue')
...
const routes: RouteRecordRaw[] = [
  ...
  // NEW: Inventory Management Routes
  {
    ...
    meta: {
      title: 'Inventar bearbeiten - MyMove',
      requiresAuth: false // Public access for customers
    }
  },
  // NEW: Offer Comparison Routes
  {
    path: '/offers/:offerId/offers',
    name: 'OfferComparison',
    component: OfferComparisonView,
    meta: {
      title: 'Angebote vergleichen - MyMove',
      requiresAuth: false // Public access for customers
    }
  },
  // Redirect for old routes
  {
    path: '/offers/:offerId/comparison',
    redirect: to => ({
      name: 'OfferComparison',
      params: { offerId: to.params.offerId }
    })
  },
  {
    path: '/:pathMatch(.*)*',
